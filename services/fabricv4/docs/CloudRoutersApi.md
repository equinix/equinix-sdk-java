...
<a id="getGatewayAttachmentToCloudRouterByUuid"></a>
# **getGatewayAttachmentToCloudRouterByUuid**
> CloudRouterForGatewayAttachmentResponse getGatewayAttachmentToCloudRouterByUuid(gatewayId, routerId)
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID routerId = UUID.randomUUID(); // UUID | Cloud Router UUID
    try {
      CloudRouterForGatewayAttachmentResponse result = apiInstance.getGatewayAttachmentToCloudRouterByUuid(gatewayId, routerId);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CloudRoutersApi#getGatewayAttachmentToCloudRouterByUuid");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="listGatewayAttachmentsToCloudRouter"></a>
# **listGatewayAttachmentsToCloudRouter**
> CloudRouterListForGatewayAttachment listGatewayAttachmentsToCloudRouter(gatewayId, offset, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer limit = 10; // Integer | number of records to fetch
    try {
      CloudRouterListForGatewayAttachment result = apiInstance.listGatewayAttachmentsToCloudRouter(gatewayId, offset, limit);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CloudRoutersApi#listGatewayAttachmentsToCloudRouter");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
