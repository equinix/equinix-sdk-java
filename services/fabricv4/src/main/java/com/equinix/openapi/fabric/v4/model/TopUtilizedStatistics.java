...
public class TopUtilizedStatistics {
  ...
  * @throws IOException if the JSON Element is invalid with respect to TopUtilizedStatistics
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TopUtilizedStatistics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Statistics.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
