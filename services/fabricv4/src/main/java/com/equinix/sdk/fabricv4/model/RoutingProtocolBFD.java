...
public class RoutingProtocolBFD {
  ...
  public RoutingProtocolBFD enabled(@javax.annotation.Nonnull Boolean enabled) {
  ...
  public RoutingProtocolBFD interval(@javax.annotation.Nullable String interval) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("enabled", "interval"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RoutingProtocolBFD
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoutingProtocolBFD.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RoutingProtocolBFD is not found in the empty JSON string", RoutingProtocolBFD.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoutingProtocolBFD.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RoutingProtocolBFD` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
