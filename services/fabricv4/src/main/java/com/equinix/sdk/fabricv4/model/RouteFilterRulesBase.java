...
public class RouteFilterRulesBase {
  ...
  public RouteFilterRulesBase name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public RouteFilterRulesBase description(@javax.annotation.Nullable String description) {
  ...
  public RouteFilterRulesBase prefix(@javax.annotation.Nonnull String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public RouteFilterRulesBase prefixMatch(@javax.annotation.Nullable String prefixMatch) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "description", "prefix", "prefixMatch"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteFilterRulesBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteFilterRulesBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RouteFilterRulesBase is not found in the empty JSON string", RouteFilterRulesBase.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteFilterRulesBase.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteFilterRulesBase` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("prefixMatch") != null && !jsonObj.get("prefixMatch").isJsonNull()) && !jsonObj.get("prefixMatch").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `prefixMatch` to be a primitive type in the JSON string but got `%s`", jsonObj.get("prefixMatch").toString()));
      }
  }
