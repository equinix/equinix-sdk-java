...
public class AlertRulePutRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, type, description, enabled, metricSelector, resourceSelector, detectionMethod);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertRulePutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AlertRulePutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
