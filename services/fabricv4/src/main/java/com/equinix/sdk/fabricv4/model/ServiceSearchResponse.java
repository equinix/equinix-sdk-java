...
import com.equinix.sdk.fabricv4.model.PrecisionTimeServiceResponse;
...
public class ServiceSearchResponse {
  ...
  public ServiceSearchResponse pagination(@javax.annotation.Nullable Pagination pagination) {
  ...
  public ServiceSearchResponse data(@javax.annotation.Nullable List<PrecisionTimeServiceResponse> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<PrecisionTimeServiceResponse> data) {
    this.data = data;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ServiceSearchResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ServiceSearchResponse is not found in the empty JSON string", ServiceSearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ServiceSearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PrecisionTimeServiceResponse.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
