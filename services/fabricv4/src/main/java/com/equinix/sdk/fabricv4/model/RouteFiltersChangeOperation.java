...
public class RouteFiltersChangeOperation {
  ...
  public RouteFiltersChangeOperation op(@javax.annotation.Nonnull OpEnum op) {
    this.op = op;
    return this;
  }
  ...
  public RouteFiltersChangeOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public RouteFiltersChangeOperation value(@javax.annotation.Nonnull RouteFiltersBase value) {
    this.value = value;
    return this;
  }
  ...
  public void setValue(@javax.annotation.Nonnull RouteFiltersBase value) {
    this.value = value;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteFiltersChangeOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteFiltersChangeOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RouteFiltersChangeOperation is not found in the empty JSON string", RouteFiltersChangeOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteFiltersChangeOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteFiltersChangeOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      RouteFiltersBase.validateJsonElement(jsonObj.get("value"));
  }
