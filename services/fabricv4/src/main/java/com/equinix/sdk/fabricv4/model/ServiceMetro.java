...
public class ServiceMetro {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("code", "name", "vcBandwidthMax", "ibxs", "inTrail", "displayName", "sellerRegions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceMetro.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ServiceMetro is not found in the empty JSON string", ServiceMetro.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceMetro.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ServiceMetro` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ibxs") != null && !jsonObj.get("ibxs").isJsonNull() && !jsonObj.get("ibxs").isJsonArray()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ibxs` to be an array in the JSON string but got `%s`", jsonObj.get("ibxs").toString()));
      }
