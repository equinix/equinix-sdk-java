...
public class StreamSubscriptionPostRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, description, enabled, metricSelector, eventSelector, sink);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "name", "description", "enabled", "metricSelector", "eventSelector", "sink"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSubscriptionPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in StreamSubscriptionPostRequest is not found in the empty JSON string", StreamSubscriptionPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSubscriptionPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StreamSubscriptionPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
