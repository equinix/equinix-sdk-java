...
public class Subnet {
  ...
  public Subnet type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Subnet name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Subnet id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Subnet vpcId(@javax.annotation.Nullable String vpcId) {
    this.vpcId = vpcId;
    return this;
  }
  ...
  public Subnet ipv4(@javax.annotation.Nullable String ipv4) {
    this.ipv4 = ipv4;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "name", "id", "vpcId", "ipv4"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Subnet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Subnet is not found in the empty JSON string", Subnet.openapiRequiredFields.toString()));
        }
      }
