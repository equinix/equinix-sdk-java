...
public class ConnectionInvitation {
  ...
  public ConnectionInvitation email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public ConnectionInvitation message(@javax.annotation.Nullable String message) {
  ...
  public ConnectionInvitation ctrDraftOrderId(@javax.annotation.Nullable String ctrDraftOrderId) {
  ...
  public void setCtrDraftOrderId(@javax.annotation.Nullable String ctrDraftOrderId) {
    this.ctrDraftOrderId = ctrDraftOrderId;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("email", "message", "ctrDraftOrderId"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConnectionInvitation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionInvitation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ConnectionInvitation is not found in the empty JSON string", ConnectionInvitation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionInvitation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConnectionInvitation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("ctrDraftOrderId") != null && !jsonObj.get("ctrDraftOrderId").isJsonNull()) && !jsonObj.get("ctrDraftOrderId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `ctrDraftOrderId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ctrDraftOrderId").toString()));
      }
  }
