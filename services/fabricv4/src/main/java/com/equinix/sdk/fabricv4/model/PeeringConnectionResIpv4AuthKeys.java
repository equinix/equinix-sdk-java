...
public class PeeringConnectionResIpv4AuthKeys {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "key"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PeeringConnectionResIpv4AuthKeys.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PeeringConnectionResIpv4AuthKeys is not found in the empty JSON string", PeeringConnectionResIpv4AuthKeys.openapiRequiredFields.toString()));
        }
      }
