...
public class CloudRouter {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, uuid, name, state, equinixAsn, connectionsCount, marketplaceSubscription, changeLog, change, type, location, _package, order, project, account, notifications);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudRouter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CloudRouter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
