...
public class StreamSubscriptionPutRequest {
  ...
  public StreamSubscriptionPutRequest description(@javax.annotation.Nullable String description) {
  ...
  public StreamSubscriptionPutRequest enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public StreamSubscriptionPutRequest filters(@javax.annotation.Nullable StreamSubscriptionFilter filters) {
  ...
  public StreamSubscriptionPutRequest metricSelector(@javax.annotation.Nullable StreamSubscriptionSelector metricSelector) {
  ...
  public StreamSubscriptionPutRequest eventSelector(@javax.annotation.Nullable StreamSubscriptionSelector eventSelector) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, description, enabled, filters, metricSelector, eventSelector, sink);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "name", "description", "enabled", "filters", "metricSelector", "eventSelector", "sink"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "name", "sink"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StreamSubscriptionPutRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSubscriptionPutRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in StreamSubscriptionPutRequest is not found in the empty JSON string", StreamSubscriptionPutRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSubscriptionPutRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StreamSubscriptionPutRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
