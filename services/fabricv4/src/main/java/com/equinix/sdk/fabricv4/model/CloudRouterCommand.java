...
public class CloudRouterCommand {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, type, uuid, name, description, state, project, request, response, changeLog);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "type", "uuid", "name", "description", "state", "project", "request", "response", "changeLog"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudRouterCommand.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CloudRouterCommand is not found in the empty JSON string", CloudRouterCommand.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudRouterCommand.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CloudRouterCommand` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
