...
public class VirtualDevice {
  ...
  public VirtualDevice uuid(@javax.annotation.Nullable UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public VirtualDevice name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public VirtualDevice type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public VirtualDevice account(@javax.annotation.Nullable SimplifiedAccount account) {
  ...
  public VirtualDevice cluster(@javax.annotation.Nullable String cluster) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to VirtualDevice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VirtualDevice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in VirtualDevice is not found in the empty JSON string", VirtualDevice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VirtualDevice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VirtualDevice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
