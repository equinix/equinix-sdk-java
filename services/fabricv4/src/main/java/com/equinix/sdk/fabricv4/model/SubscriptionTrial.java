...
public class SubscriptionTrial {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enabled, expiryDateTime);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("enabled", "expiryDateTime"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubscriptionTrial.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SubscriptionTrial is not found in the empty JSON string", SubscriptionTrial.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionTrial.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SubscriptionTrial` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
