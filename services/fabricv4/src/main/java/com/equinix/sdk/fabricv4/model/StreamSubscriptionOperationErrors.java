...
public class StreamSubscriptionOperationErrors {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errorCode, errorMessage, dateTime, additionalInfo);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSubscriptionOperationErrors.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StreamSubscriptionOperationErrors` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
