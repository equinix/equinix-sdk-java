...
public class RouteTableEntry {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "protocolType", "state", "age", "prefix", "nextHop", "MED", "localPreference", "asPath", "connection", "changeLog"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("age") != null && !jsonObj.get("age").isJsonNull()) && !jsonObj.get("age").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `age` to be a primitive type in the JSON string but got `%s`", jsonObj.get("age").toString()));
      }
