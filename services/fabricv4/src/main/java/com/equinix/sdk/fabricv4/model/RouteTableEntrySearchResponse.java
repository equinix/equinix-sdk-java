...
import com.equinix.sdk.fabricv4.model.RouteTableEntry;
...
public class RouteTableEntrySearchResponse {
  ...
  public RouteTableEntrySearchResponse pagination(@javax.annotation.Nullable Pagination pagination) {
  ...
  public RouteTableEntrySearchResponse data(@javax.annotation.Nullable List<RouteTableEntry> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<RouteTableEntry> data) {
    this.data = data;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteTableEntrySearchResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteTableEntrySearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RouteTableEntrySearchResponse is not found in the empty JSON string", RouteTableEntrySearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteTableEntrySearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteTableEntrySearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            RouteTableEntry.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
