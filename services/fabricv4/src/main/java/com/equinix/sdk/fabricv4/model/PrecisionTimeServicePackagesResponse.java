...
public class PrecisionTimeServicePackagesResponse {
  ...
  public PrecisionTimeServicePackagesResponse pagination(@javax.annotation.Nullable Pagination pagination) {
  ...
  public PrecisionTimeServicePackagesResponse data(@javax.annotation.Nullable List<PrecisionTimePackageResponse> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<PrecisionTimePackageResponse> data) {
    this.data = data;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PrecisionTimeServicePackagesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrecisionTimeServicePackagesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PrecisionTimeServicePackagesResponse is not found in the empty JSON string", PrecisionTimeServicePackagesResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrecisionTimeServicePackagesResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PrecisionTimeServicePackagesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PrecisionTimePackageResponse.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
