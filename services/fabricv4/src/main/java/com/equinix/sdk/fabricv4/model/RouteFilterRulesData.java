...
public class RouteFilterRulesData {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "type", "uuid", "name", "description", "state", "prefixMatch", "change", "action", "prefix", "changelog"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteFilterRulesData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RouteFilterRulesData is not found in the empty JSON string", RouteFilterRulesData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteFilterRulesData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteFilterRulesData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
