...
import com.equinix.sdk.fabricv4.model.SearchStreamSubscriptionResponse;
...
import com.equinix.sdk.fabricv4.model.StreamSubscriptionSearchRequest;
...
public class StreamSubscriptionsApi {
    ...
    /**
     * Build call for searchStreamSubscriptions
     * @param streamSubscriptionSearchRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call searchStreamSubscriptionsCall(@javax.annotation.Nonnull StreamSubscriptionSearchRequest streamSubscriptionSearchRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = streamSubscriptionSearchRequest;

        // create path and map variables
        String localVarPath = "/fabric/v4/streamSubscriptions/search";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchStreamSubscriptionsValidateBeforeCall(@javax.annotation.Nonnull StreamSubscriptionSearchRequest streamSubscriptionSearchRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'streamSubscriptionSearchRequest' is set
        if (streamSubscriptionSearchRequest == null) {
            throw new ApiException("Missing the required parameter 'streamSubscriptionSearchRequest' when calling searchStreamSubscriptions(Async)");
        }

        return searchStreamSubscriptionsCall(streamSubscriptionSearchRequest, _callback);
     ...
     */
    public SearchStreamSubscriptionResponse searchStreamSubscriptions(@javax.annotation.Nonnull StreamSubscriptionSearchRequest streamSubscriptionSearchRequest) throws ApiException {
        ApiResponse<SearchStreamSubscriptionResponse> localVarResp = searchStreamSubscriptionsWithHttpInfo(streamSubscriptionSearchRequest);
        return localVarResp.getData();
    }
     ...
     * This API provides capability to search stream subscriptions
     * @param streamSubscriptionSearchRequest  (required)
     * @return ApiResponse&lt;SearchStreamSubscriptionResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<SearchStreamSubscriptionResponse> searchStreamSubscriptionsWithHttpInfo(@javax.annotation.Nonnull StreamSubscriptionSearchRequest streamSubscriptionSearchRequest) throws ApiException {
        okhttp3.Call localVarCall = searchStreamSubscriptionsValidateBeforeCall(streamSubscriptionSearchRequest, null);
        Type localVarReturnType = new TypeToken<SearchStreamSubscriptionResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Search Stream Subscriptions (asynchronously)
     * This API provides capability to search stream subscriptions
     * @param streamSubscriptionSearchRequest  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call searchStreamSubscriptionsAsync(@javax.annotation.Nonnull StreamSubscriptionSearchRequest streamSubscriptionSearchRequest, final ApiCallback<SearchStreamSubscriptionResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchStreamSubscriptionsValidateBeforeCall(streamSubscriptionSearchRequest, _callback);
        Type localVarReturnType = new TypeToken<SearchStreamSubscriptionResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
