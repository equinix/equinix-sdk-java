...
public class CompanyProfileResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, uuid, type, name, summary, description, state, account, metros, logo, tags, serviceProfiles, privateServices, notifications, webUrl, contactUrl, change, changeLog);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyProfileResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CompanyProfileResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
