...
import com.equinix.sdk.fabricv4.model.SubscriptionTrial;
...
public class SubscriptionResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, uuid, state, marketplace, offerType, isAutoRenew, offerId, trial, metroCodes, entitlements, changelog);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SubscriptionResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SubscriptionResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
