  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayAttachmentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GatewayAttachmentResponse is not found in the empty JSON string", GatewayAttachmentResponse.openapiRequiredFields.toString()));
        }
      }
