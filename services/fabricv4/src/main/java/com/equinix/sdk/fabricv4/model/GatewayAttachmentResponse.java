...
public class GatewayAttachmentResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, type, uuid, attachmentStatus, errors, changeLog);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayAttachmentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayAttachmentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
