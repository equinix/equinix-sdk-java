...
import com.equinix.sdk.fabricv4.model.CloudRouterOrFilter;
import com.equinix.sdk.fabricv4.model.CloudRouterSimpleExpression;
...
public class CloudRouterFilter extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<CloudRouterFilter>() {
                ...
                public CloudRouterFilter read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for CloudRouterSimpleExpression failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for CloudRouterOrFilter failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'CloudRouterOrFilter'", e);
                    }

                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for CloudRouterFilter: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CloudRouterFilter(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for CloudRouterFilter with anyOf schemas: CloudRouterOrFilter, CloudRouterSimpleExpression. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }
