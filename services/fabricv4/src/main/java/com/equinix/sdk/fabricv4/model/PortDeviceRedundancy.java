...
public class PortDeviceRedundancy {
  ...
  public PortDeviceRedundancy group(@javax.annotation.Nullable String group) {
    this.group = group;
    return this;
  }
  ...
  public PortDeviceRedundancy priority(@javax.annotation.Nullable PriorityEnum priority) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PortDeviceRedundancy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortDeviceRedundancy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PortDeviceRedundancy is not found in the empty JSON string", PortDeviceRedundancy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PortDeviceRedundancy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PortDeviceRedundancy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
