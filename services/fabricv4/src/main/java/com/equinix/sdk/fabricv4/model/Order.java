...
public class Order {
  ...
  public Order purchaseOrderNumber(@javax.annotation.Nullable String purchaseOrderNumber) {
  ...
  public Order customerReferenceNumber(@javax.annotation.Nullable String customerReferenceNumber) {
  ...
  public Order billingTier(@javax.annotation.Nullable String billingTier) {
  ...
  public Order orderId(@javax.annotation.Nullable String orderId) {
  ...
  public Order orderNumber(@javax.annotation.Nullable String orderNumber) {
  ...
  public Order termLength(@javax.annotation.Nullable Integer termLength) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(purchaseOrderNumber, customerReferenceNumber, billingTier, orderId, orderNumber, termLength, contractedBandwidth);
  }
