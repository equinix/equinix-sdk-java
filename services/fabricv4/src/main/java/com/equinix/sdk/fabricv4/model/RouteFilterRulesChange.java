...
public class RouteFilterRulesChange {
  ...
  public RouteFilterRulesChange uuid(@javax.annotation.Nonnull String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public RouteFilterRulesChange type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public RouteFilterRulesChange href(@javax.annotation.Nullable URI href) {
    this.href = href;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteFilterRulesChange
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteFilterRulesChange.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RouteFilterRulesChange is not found in the empty JSON string", RouteFilterRulesChange.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteFilterRulesChange.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteFilterRulesChange` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
