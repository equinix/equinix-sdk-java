...
public class ServiceProfileUpdateOperation extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ServiceProfileUpdateOperation.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ServiceProfileUpdateOperation.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ServiceProfileUpdateOperation' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ServiceProfileUpdateOperation>() {
                @Override
                public void write(JsonWriter out, ServiceProfileUpdateOperation value) throws IOException {
                ...
                @Override
                public ServiceProfileUpdateOperation read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ServiceProfileUpdateOperation ret = new ServiceProfileUpdateOperation();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for ServiceProfileUpdateOperation: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ServiceProfileUpdateOperation() {
        super("oneOf", Boolean.FALSE);
    }

    public ServiceProfileUpdateOperation(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ServiceProfileUpdateOperation.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ServiceProfileUpdateOperation
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(Locale.ROOT, "The JSON string is invalid for ServiceProfileUpdateOperation with oneOf schemas: AddOperation, RemoveOperation, ReplaceOperation. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ServiceProfileUpdateOperation given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ServiceProfileUpdateOperation
     * @throws IOException if the JSON string is invalid with respect to ServiceProfileUpdateOperation
     */
    public static ServiceProfileUpdateOperation fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ServiceProfileUpdateOperation.class);
    }

    /**
     * Convert an instance of ServiceProfileUpdateOperation to an JSON string
     *
     * @return JSON string
     */
