...
import com.equinix.sdk.fabricv4.model.MessagesInner;
...
public class ChatMessage {
  ...
  public ChatMessage messages(@javax.annotation.Nullable List<MessagesInner> messages) {
    this.messages = messages;
    return this;
  }

  public ChatMessage addMessagesItem(MessagesInner messagesItem) {
  ...
  public void setMessages(@javax.annotation.Nullable List<MessagesInner> messages) {
    this.messages = messages;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.messages, chatMessage.messages);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChatMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ChatMessage is not found in the empty JSON string", ChatMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ChatMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ChatMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("messages") != null && !jsonObj.get("messages").isJsonNull()) {
        ...
        if (jsonArraymessages != null) {
          ...
          for (int i = 0; i < jsonArraymessages.size(); i++) {
            MessagesInner.validateJsonElement(jsonArraymessages.get(i));
          };
        }
      }
  }
