...
public class RouteAggregationRulesData {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, type, uuid, name, description, state, change, prefix, changeLog);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "type", "uuid", "name", "description", "state", "change", "prefix", "changeLog"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteAggregationRulesData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RouteAggregationRulesData is not found in the empty JSON string", RouteAggregationRulesData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteAggregationRulesData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteAggregationRulesData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
