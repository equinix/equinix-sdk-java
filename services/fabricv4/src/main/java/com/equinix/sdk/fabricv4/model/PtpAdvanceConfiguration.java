...
public class PtpAdvanceConfiguration {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PtpAdvanceConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PtpAdvanceConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
