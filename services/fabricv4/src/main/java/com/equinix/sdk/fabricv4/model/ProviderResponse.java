            ...
            return (TypeAdapter<T>) new TypeAdapter<ProviderResponse>() {
                ...
                public ProviderResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for FabricProviderResponse failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for AWSProviderResponse failed with `%s`.", e.getMessage()));
                    ...
                    try {
                        ...
                        // deserialization failed, continue
                        errorMessages.add(String.format(Locale.ROOT, "Deserialization for GCPProviderResponse failed with `%s`.", e.getMessage()));
                    ...
                    throw new IOException(String.format(Locale.ROOT, "Failed deserialization for ProviderResponse: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
