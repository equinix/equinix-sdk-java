...
public class PortChangeOperation {
  ...
  public PortChangeOperation op(@javax.annotation.Nonnull String op) {
    this.op = op;
    return this;
  }
  ...
  public PortChangeOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public PortChangeOperation value(@javax.annotation.Nonnull Object value) {
    this.value = value;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PortChangeOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PortChangeOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PortChangeOperation is not found in the empty JSON string", PortChangeOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PortChangeOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PortChangeOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
