...
import com.equinix.sdk.fabricv4.model.Expression;
import com.equinix.sdk.fabricv4.model.PaginationRequest;
import com.equinix.sdk.fabricv4.model.SortCriteria;
...
public class SearchRequest {
  ...
  public SearchRequest filter(@javax.annotation.Nullable Expression filter) {
    this.filter = filter;
    return this;
  }
  ...
  public void setFilter(@javax.annotation.Nullable Expression filter) {
    this.filter = filter;
  }


  public SearchRequest pagination(@javax.annotation.Nullable PaginationRequest pagination) {
  ...
  public SearchRequest sort(@javax.annotation.Nullable List<SortCriteria> sort) {
    this.sort = sort;
    return this;
  }
  ...
  public void setSort(@javax.annotation.Nullable List<SortCriteria> sort) {
    this.sort = sort;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in SearchRequest is not found in the empty JSON string", SearchRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SearchRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("sort") != null && !jsonObj.get("sort").isJsonNull()) {
        ...
        if (jsonArraysort != null) {
          ...
          for (int i = 0; i < jsonArraysort.size(); i++) {
            SortCriteria.validateJsonElement(jsonArraysort.get(i));
          };
        }
      }
  }
