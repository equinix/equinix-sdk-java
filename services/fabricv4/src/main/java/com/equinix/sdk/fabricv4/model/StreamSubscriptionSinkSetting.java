...
public class StreamSubscriptionSinkSetting {
  ...
  public StreamSubscriptionSinkSetting format(@javax.annotation.Nullable FormatEnum format) {
    this.format = format;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(eventIndex, metricIndex, source, applicationKey, eventUri, metricUri, format);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSubscriptionSinkSetting.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StreamSubscriptionSinkSetting` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
