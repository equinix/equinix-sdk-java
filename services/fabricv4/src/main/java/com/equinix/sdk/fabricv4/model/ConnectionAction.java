...
public class ConnectionAction {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "href", "uuid", "description", "data", "changeLog"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "uuid", "data"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ConnectionAction is not found in the empty JSON string", ConnectionAction.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionAction.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConnectionAction` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
