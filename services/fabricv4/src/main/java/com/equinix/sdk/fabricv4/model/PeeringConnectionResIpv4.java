  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PeeringConnectionResIpv4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PeeringConnectionResIpv4 is not found in the empty JSON string", PeeringConnectionResIpv4.openapiRequiredFields.toString()));
        }
      }
