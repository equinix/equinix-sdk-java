...
public class PeeringConnectionResIpv4 {
  ...
  public PeeringConnectionResIpv4() {
  }

  public PeeringConnectionResIpv4 customerPeerIp(@javax.annotation.Nullable String customerPeerIp) {
  ...
  public PeeringConnectionResIpv4 primaryEquinixPeerIp(@javax.annotation.Nullable String primaryEquinixPeerIp) {
  ...
  public PeeringConnectionResIpv4 secondaryEquinixPeerIp(@javax.annotation.Nullable String secondaryEquinixPeerIp) {
  ...
  public PeeringConnectionResIpv4 reverseDnsAddress(@javax.annotation.Nullable String reverseDnsAddress) {
  ...
  public PeeringConnectionResIpv4 asSet(@javax.annotation.Nullable String asSet) {
    this.asSet = asSet;
    return this;
  }
  ...
  public PeeringConnectionResIpv4 mlpeEnabled(@javax.annotation.Nullable Boolean mlpeEnabled) {
  ...
  public PeeringConnectionResIpv4 authKeys(@javax.annotation.Nullable List<PeeringConnectionResIpv4AuthKeys> authKeys) {
    this.authKeys = authKeys;
    return this;
  }

  public PeeringConnectionResIpv4 addAuthKeysItem(PeeringConnectionResIpv4AuthKeys authKeysItem) {
  ...
  public PeeringConnectionResIpv4 ipPrefixes(@javax.annotation.Nullable List<String> ipPrefixes) {
    this.ipPrefixes = ipPrefixes;
    return this;
  }

  public PeeringConnectionResIpv4 addIpPrefixesItem(String ipPrefixesItem) {
  ...
  public PeeringConnectionResIpv4 enabled(@javax.annotation.Nullable Boolean enabled) {
   ...
   * @return the PeeringConnectionResIpv4 instance itself
   */
  public PeeringConnectionResIpv4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PeeringConnectionResIpv4 peeringConnectionResIpv4 = (PeeringConnectionResIpv4) o;
    return Objects.equals(this.customerPeerIp, peeringConnectionResIpv4.customerPeerIp) &&
        Objects.equals(this.primaryEquinixPeerIp, peeringConnectionResIpv4.primaryEquinixPeerIp) &&
        Objects.equals(this.secondaryEquinixPeerIp, peeringConnectionResIpv4.secondaryEquinixPeerIp) &&
        Objects.equals(this.reverseDnsAddress, peeringConnectionResIpv4.reverseDnsAddress) &&
        Objects.equals(this.asSet, peeringConnectionResIpv4.asSet) &&
        Objects.equals(this.mlpeEnabled, peeringConnectionResIpv4.mlpeEnabled) &&
        Objects.equals(this.authKeys, peeringConnectionResIpv4.authKeys) &&
        Objects.equals(this.ipPrefixes, peeringConnectionResIpv4.ipPrefixes) &&
        Objects.equals(this.enabled, peeringConnectionResIpv4.enabled)&&
        Objects.equals(this.additionalProperties, peeringConnectionResIpv4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PeeringConnectionResIpv4 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PeeringConnectionResIpv4
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PeeringConnectionResIpv4.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PeeringConnectionResIpv4 is not found in the empty JSON string", PeeringConnectionResIpv4.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PeeringConnectionResIpv4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PeeringConnectionResIpv4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PeeringConnectionResIpv4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PeeringConnectionResIpv4.class));

       return (TypeAdapter<T>) new TypeAdapter<PeeringConnectionResIpv4>() {
           @Override
           public void write(JsonWriter out, PeeringConnectionResIpv4 value) throws IOException {
           ...
           @Override
           public PeeringConnectionResIpv4 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PeeringConnectionResIpv4 instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PeeringConnectionResIpv4 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PeeringConnectionResIpv4
   * @throws IOException if the JSON string is invalid with respect to PeeringConnectionResIpv4
   */
  public static PeeringConnectionResIpv4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PeeringConnectionResIpv4.class);
  }

  /**
   * Convert an instance of PeeringConnectionResIpv4 to an JSON string
   *
   * @return JSON string
   */
