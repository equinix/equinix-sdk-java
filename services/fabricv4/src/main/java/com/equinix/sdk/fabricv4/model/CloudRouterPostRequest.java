...
public class CloudRouterPostRequest {
  ...
  public CloudRouterPostRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CloudRouterPostRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CloudRouterPostRequest location(@javax.annotation.Nonnull SimplifiedLocationWithoutIBX location) {
  ...
  public CloudRouterPostRequest _package(@javax.annotation.Nonnull CloudRouterPostRequestPackage _package) {
  ...
  static {
    ...
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "name", "location", "package"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudRouterPostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CloudRouterPostRequest is not found in the empty JSON string", CloudRouterPostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudRouterPostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CloudRouterPostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
