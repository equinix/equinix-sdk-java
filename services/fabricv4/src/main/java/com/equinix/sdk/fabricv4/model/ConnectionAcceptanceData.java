...
public class ConnectionAcceptanceData {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(zSide, providerBandwidth);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("zSide", "providerBandwidth"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConnectionAcceptanceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ConnectionAcceptanceData is not found in the empty JSON string", ConnectionAcceptanceData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConnectionAcceptanceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConnectionAcceptanceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
