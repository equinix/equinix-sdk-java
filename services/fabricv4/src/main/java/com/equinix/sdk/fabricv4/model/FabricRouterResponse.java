...
public class FabricRouterResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "type", "uuid", "state", "name", "location", "package", "deploymentProperties"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "state", "name", "location", "package", "deploymentProperties"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FabricRouterResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in FabricRouterResponse is not found in the empty JSON string", FabricRouterResponse.openapiRequiredFields.toString()));
        }
      }
