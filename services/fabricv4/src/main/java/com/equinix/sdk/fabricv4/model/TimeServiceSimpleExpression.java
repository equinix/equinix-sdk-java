...
public class TimeServiceSimpleExpression {
  ...
  public TimeServiceSimpleExpression property(@javax.annotation.Nullable String property) {
  ...
  public TimeServiceSimpleExpression operator(@javax.annotation.Nullable String operator) {
  ...
  public TimeServiceSimpleExpression values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeServiceSimpleExpression
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeServiceSimpleExpression.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in TimeServiceSimpleExpression is not found in the empty JSON string", TimeServiceSimpleExpression.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeServiceSimpleExpression.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TimeServiceSimpleExpression` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
