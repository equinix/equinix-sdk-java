...
import com.equinix.sdk.fabricv4.model.VirtualConnectionUuid;
...
public class PrecisionTimeServiceRequest {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, _package, connections, ipv4, ntpAdvancedConfiguration, ptpAdvancedConfiguration, project, order);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrecisionTimeServiceRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PrecisionTimeServiceRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
