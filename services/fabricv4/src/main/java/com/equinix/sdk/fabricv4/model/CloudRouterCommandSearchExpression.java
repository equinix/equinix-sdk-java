...
public class CloudRouterCommandSearchExpression {
  ...
  public CloudRouterCommandSearchExpression property(@javax.annotation.Nullable String property) {
  ...
  public CloudRouterCommandSearchExpression operator(@javax.annotation.Nullable String operator) {
  ...
  public CloudRouterCommandSearchExpression values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudRouterCommandSearchExpression
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudRouterCommandSearchExpression.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CloudRouterCommandSearchExpression is not found in the empty JSON string", CloudRouterCommandSearchExpression.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudRouterCommandSearchExpression.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CloudRouterCommandSearchExpression` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
