...
public class GCPPermission {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "projectId", "providerId", "poolId", "deploymentProperties"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "projectId", "providerId", "poolId", "deploymentProperties"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GCPPermission.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GCPPermission is not found in the empty JSON string", GCPPermission.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("poolId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `poolId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("poolId").toString()));
      }
