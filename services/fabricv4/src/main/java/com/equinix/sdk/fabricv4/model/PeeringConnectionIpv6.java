...
public class PeeringConnectionIpv6 {
  ...
  public PeeringConnectionIpv6() {
  }

  public PeeringConnectionIpv6 reverseDnsAddress(@javax.annotation.Nullable String reverseDnsAddress) {
  ...
  public PeeringConnectionIpv6 asSet(@javax.annotation.Nullable String asSet) {
    this.asSet = asSet;
    return this;
  }
  ...
  public PeeringConnectionIpv6 mlpeEnabled(@javax.annotation.Nullable Boolean mlpeEnabled) {
  ...
  public PeeringConnectionIpv6 authKeys(@javax.annotation.Nullable List<PeeringConnectionIpv4AuthKeys> authKeys) {
    this.authKeys = authKeys;
    return this;
  }

  public PeeringConnectionIpv6 addAuthKeysItem(PeeringConnectionIpv4AuthKeys authKeysItem) {
  ...
  public PeeringConnectionIpv6 ipPrefixes(@javax.annotation.Nullable List<String> ipPrefixes) {
    this.ipPrefixes = ipPrefixes;
    return this;
  }

  public PeeringConnectionIpv6 addIpPrefixesItem(String ipPrefixesItem) {
   ...
   * @return the PeeringConnectionIpv6 instance itself
   */
  public PeeringConnectionIpv6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PeeringConnectionIpv6 peeringConnectionIpv6 = (PeeringConnectionIpv6) o;
    return Objects.equals(this.reverseDnsAddress, peeringConnectionIpv6.reverseDnsAddress) &&
        Objects.equals(this.asSet, peeringConnectionIpv6.asSet) &&
        Objects.equals(this.mlpeEnabled, peeringConnectionIpv6.mlpeEnabled) &&
        Objects.equals(this.authKeys, peeringConnectionIpv6.authKeys) &&
        Objects.equals(this.ipPrefixes, peeringConnectionIpv6.ipPrefixes)&&
        Objects.equals(this.additionalProperties, peeringConnectionIpv6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PeeringConnectionIpv6 {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to PeeringConnectionIpv6
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PeeringConnectionIpv6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PeeringConnectionIpv6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PeeringConnectionIpv6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PeeringConnectionIpv6.class));

       return (TypeAdapter<T>) new TypeAdapter<PeeringConnectionIpv6>() {
           @Override
           public void write(JsonWriter out, PeeringConnectionIpv6 value) throws IOException {
           ...
           @Override
           public PeeringConnectionIpv6 read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             PeeringConnectionIpv6 instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of PeeringConnectionIpv6 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PeeringConnectionIpv6
   * @throws IOException if the JSON string is invalid with respect to PeeringConnectionIpv6
   */
  public static PeeringConnectionIpv6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PeeringConnectionIpv6.class);
  }

  /**
   * Convert an instance of PeeringConnectionIpv6 to an JSON string
   *
   * @return JSON string
   */
