...
public class AccessPoint {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, account, location, port, profile, router, linkProtocol, virtualDevice, _interface, network, environment, sellerRegion, peeringType, authenticationKey, activationKey, providerConnectionId, virtualNetwork, interconnection, role);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AccessPoint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AccessPoint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
