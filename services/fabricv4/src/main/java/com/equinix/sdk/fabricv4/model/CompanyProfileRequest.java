...
public class CompanyProfileRequest {
   ...
   * @return the CompanyProfileRequest instance itself
   */
  public CompanyProfileRequest putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CompanyProfileRequest>() {
           ...
           public CompanyProfileRequest read(JsonReader in) throws IOException {
             ...
             CompanyProfileRequest instance = thisAdapter.fromJsonTree(jsonObj);
