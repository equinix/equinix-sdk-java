...
public class CompanyProfileRequest {
  ...
  public CompanyProfileRequest type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public CompanyProfileRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CompanyProfileRequest summary(@javax.annotation.Nonnull String summary) {
  ...
  public CompanyProfileRequest description(@javax.annotation.Nonnull String description) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyProfileRequest companyProfileRequest = (CompanyProfileRequest) o;
    return Objects.equals(this.type, companyProfileRequest.type) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, summary, description, notifications, webUrl, contactUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CompanyProfileRequest {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CompanyProfileRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanyProfileRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CompanyProfileRequest is not found in the empty JSON string", CompanyProfileRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyProfileRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CompanyProfileRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CompanyProfileRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CompanyProfileRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CompanyProfileRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CompanyProfileRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CompanyProfileRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CompanyProfileRequest>() {
           @Override
           public void write(JsonWriter out, CompanyProfileRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CompanyProfileRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CompanyProfileRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CompanyProfileRequest
   * @throws IOException if the JSON string is invalid with respect to CompanyProfileRequest
   */
  public static CompanyProfileRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CompanyProfileRequest.class);
  }

  /**
   * Convert an instance of CompanyProfileRequest to an JSON string
   *
   * @return JSON string
   */
