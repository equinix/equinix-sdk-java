...
public class AttachLogoResponse {
  ...
  public AttachLogoResponse href(@javax.annotation.Nullable String href) {
    this.href = href;
    return this;
  }
  ...
  public AttachLogoResponse type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public AttachLogoResponse uuid(@javax.annotation.Nonnull String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public AttachLogoResponse attachmentStatus(@javax.annotation.Nullable String attachmentStatus) {
  ...
  public boolean equals(Object o) {
    ...
    AttachLogoResponse attachLogoResponse = (AttachLogoResponse) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, type, uuid, attachmentStatus, extensionType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AttachLogoResponse {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AttachLogoResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AttachLogoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AttachLogoResponse is not found in the empty JSON string", AttachLogoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttachLogoResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AttachLogoResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttachLogoResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachLogoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachLogoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachLogoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachLogoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachLogoResponse>() {
           @Override
           public void write(JsonWriter out, AttachLogoResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachLogoResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AttachLogoResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AttachLogoResponse
   * @throws IOException if the JSON string is invalid with respect to AttachLogoResponse
   */
  public static AttachLogoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachLogoResponse.class);
  }

  /**
   * Convert an instance of AttachLogoResponse to an JSON string
   *
   * @return JSON string
   */
