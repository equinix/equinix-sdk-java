...
public class CompanyLogo {
   ...
   * @return the CompanyLogo instance itself
   */
  public CompanyLogo putAdditionalProperty(String key, Object value) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CompanyLogo>() {
           ...
           public CompanyLogo read(JsonReader in) throws IOException {
             ...
             CompanyLogo instance = thisAdapter.fromJsonTree(jsonObj);
