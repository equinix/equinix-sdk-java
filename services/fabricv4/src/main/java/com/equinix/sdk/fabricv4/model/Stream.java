...
public class Stream {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, uuid, type, name, description, project, state, assetsCount, streamSubscriptionsCount, alertRulesCount, changeLog);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "uuid", "type", "name", "description", "project", "state", "assetsCount", "streamSubscriptionsCount", "alertRulesCount", "changeLog"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Stream.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Stream is not found in the empty JSON string", Stream.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Stream.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Stream` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
