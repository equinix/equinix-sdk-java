...
public class CloudRouterSimpleExpression {
  ...
  public CloudRouterSimpleExpression property(@javax.annotation.Nullable String property) {
  ...
  public CloudRouterSimpleExpression operator(@javax.annotation.Nullable String operator) {
  ...
  public CloudRouterSimpleExpression values(@javax.annotation.Nullable List<String> values) {
    this.values = values;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudRouterSimpleExpression
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudRouterSimpleExpression.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CloudRouterSimpleExpression is not found in the empty JSON string", CloudRouterSimpleExpression.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudRouterSimpleExpression.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CloudRouterSimpleExpression` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
