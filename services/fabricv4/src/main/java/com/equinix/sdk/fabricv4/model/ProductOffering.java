...
public class ProductOffering {
  ...
  public ProductOffering id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ProductOffering name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
   ...
   * @return the ProductOffering instance itself
   */
  public ProductOffering putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productOffering.id) &&
        ...
        Objects.equals(this.additionalProperties, productOffering.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProductOffering.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ProductOffering is not found in the empty JSON string", ProductOffering.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       final TypeAdapter<ProductOffering> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductOffering.class));
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductOffering>() {
           ...
           public ProductOffering read(JsonReader in) throws IOException {
             ...
             ProductOffering instance = thisAdapter.fromJsonTree(jsonObj);
