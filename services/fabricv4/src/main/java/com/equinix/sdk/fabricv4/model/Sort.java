...
import com.equinix.sdk.fabricv4.model.CompanyProfileSortDirection;
...
public class Sort {
  ...
  @javax.annotation.Nullable
  private CompanyProfileSortDirection direction = CompanyProfileSortDirection.ASC;
  ...
  public Sort direction(@javax.annotation.Nullable CompanyProfileSortDirection direction) {
   ...
   */
  @javax.annotation.Nullable
  public CompanyProfileSortDirection getDirection() {
    return direction;
  }

  public void setDirection(@javax.annotation.Nullable CompanyProfileSortDirection direction) {
    this.direction = direction;
  }
   ...
   * @return the Sort instance itself
   */
  public Sort putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.property, sort.property) &&
        ...
        Objects.equals(this.additionalProperties, sort.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Sort.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Sort is not found in the empty JSON string", Sort.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("direction") != null && !jsonObj.get("direction").isJsonNull()) {
        CompanyProfileSortDirection.validateJsonElement(jsonObj.get("direction"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Sort>() {
           ...
           public Sort read(JsonReader in) throws IOException {
             ...
             Sort instance = thisAdapter.fromJsonTree(jsonObj);
