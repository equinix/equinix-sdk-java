...
public class AlertRulePostRequest {
  ...
  public AlertRulePostRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AlertRulePostRequest name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AlertRulePostRequest metricSelector(@javax.annotation.Nonnull MetricSelector metricSelector) {
  ...
  public AlertRulePostRequest resourceSelector(@javax.annotation.Nonnull ResourceSelector resourceSelector) {
  ...
  public AlertRulePostRequest detectionMethod(@javax.annotation.Nonnull DetectionMethod detectionMethod) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, alertRulePostRequest.type) &&
        ...
        Objects.equals(this.metricSelector, alertRulePostRequest.metricSelector) &&
        Objects.equals(this.resourceSelector, alertRulePostRequest.resourceSelector) &&
        Objects.equals(this.detectionMethod, alertRulePostRequest.detectionMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, name, description, enabled, metricSelector, resourceSelector, detectionMethod);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "name", "description", "enabled", "metricSelector", "resourceSelector", "detectionMethod"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("type", "name", "metricSelector", "resourceSelector", "detectionMethod"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AlertRulePostRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in AlertRulePostRequest is not found in the empty JSON string", AlertRulePostRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AlertRulePostRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AlertRulePostRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AlertRulePostRequest.openapiRequiredFields) {
