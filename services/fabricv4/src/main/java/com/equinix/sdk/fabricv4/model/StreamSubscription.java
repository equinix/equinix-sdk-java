...
public class StreamSubscription {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, uuid, type, name, description, state, enabled, metricSelector, eventSelector, sink, operation, changeLog);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "uuid", "type", "name", "description", "state", "enabled", "metricSelector", "eventSelector", "sink", "operation", "changeLog"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamSubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in StreamSubscription is not found in the empty JSON string", StreamSubscription.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StreamSubscription.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StreamSubscription` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
