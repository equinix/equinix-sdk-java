...
public class VirtualPortPrice {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, type, location, lag, physicalPortsQuantity, bandwidth, redundancy, connectivitySource, serviceType, settings, _package, serviceCode);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VirtualPortPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VirtualPortPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
