...
import com.equinix.sdk.fabricv4.model.ContactPreference;
...
public class Phone {
  ...
  public Phone type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public Phone number(@javax.annotation.Nullable String number) {
    this.number = number;
    return this;
  }
  ...
  public Phone contactPreference(@javax.annotation.Nullable ContactPreference contactPreference) {
  ...
  public void setContactPreference(@javax.annotation.Nullable ContactPreference contactPreference) {
    this.contactPreference = contactPreference;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, phone.type) &&
        ...
        Objects.equals(this.contactPreference, phone.contactPreference)&&
        Objects.equals(this.additionalProperties, phone.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, number, contactPreference, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "number", "contactPreference"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Phone.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Phone is not found in the empty JSON string", Phone.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `contactPreference`
      if (jsonObj.get("contactPreference") != null && !jsonObj.get("contactPreference").isJsonNull()) {
        ContactPreference.validateJsonElement(jsonObj.get("contactPreference"));
      }
  }
