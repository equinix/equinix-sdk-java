...
public class ServiceToken {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, href, expiry, uuid, issuerSide, name, description, expirationDateTime, connection, state, notifications, account, changelog, project);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("type", "href", "expiry", "uuid", "issuerSide", "name", "description", "expirationDateTime", "connection", "state", "notifications", "account", "changelog", "project"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ServiceToken is not found in the empty JSON string", ServiceToken.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ServiceToken` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("issuerSide") != null && !jsonObj.get("issuerSide").isJsonNull()) && !jsonObj.get("issuerSide").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(Locale.ROOT, "Expected the field `issuerSide` to be a primitive type in the JSON string but got `%s`", jsonObj.get("issuerSide").toString()));
      }
