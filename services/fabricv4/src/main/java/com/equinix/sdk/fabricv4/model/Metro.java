...
public class Metro {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, type, code, region, name, country, equinixAsn, localVCBandwidthMax, geoCoordinates, connectedMetros, services, geoScopes, geoZones);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Metro.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Metro` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
