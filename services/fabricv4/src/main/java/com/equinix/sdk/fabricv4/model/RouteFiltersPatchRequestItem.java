...
public class RouteFiltersPatchRequestItem {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteFiltersPatchRequestItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteFiltersPatchRequestItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
