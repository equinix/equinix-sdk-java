...
public class RouteFiltersSearchResponse {
  ...
  public RouteFiltersSearchResponse pagination(@javax.annotation.Nullable Pagination pagination) {
  ...
  public RouteFiltersSearchResponse data(@javax.annotation.Nullable List<RouteFiltersData> data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable List<RouteFiltersData> data) {
    this.data = data;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RouteFiltersSearchResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RouteFiltersSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in RouteFiltersSearchResponse is not found in the empty JSON string", RouteFiltersSearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RouteFiltersSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RouteFiltersSearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            RouteFiltersData.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
