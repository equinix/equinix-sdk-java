...
public class ServiceProfile {
  ...
  public void setState(@javax.annotation.Nullable ServiceProfileStateEnum state) {
    this.state = state;
  }


  public ServiceProfile account(@javax.annotation.Nullable SimplifiedAccount account) {
  ...
  public ServiceProfile project(@javax.annotation.Nullable Project project) {
  ...
  public ServiceProfile changeLog(@javax.annotation.Nullable Changelog changeLog) {
  ...
  public ServiceProfile type(@javax.annotation.Nullable ServiceProfileTypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ServiceProfile name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ServiceProfile uuid(@javax.annotation.Nullable UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public ServiceProfile description(@javax.annotation.Nullable String description) {
  ...
  public ServiceProfile notifications(@javax.annotation.Nullable List<SimplifiedNotification> notifications) {
  ...
  public ServiceProfile tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ServiceProfile visibility(@javax.annotation.Nullable ServiceProfileVisibilityEnum visibility) {
  ...
  public ServiceProfile allowedEmails(@javax.annotation.Nullable List<String> allowedEmails) {
  ...
  public ServiceProfile accessPointTypeConfigs(@javax.annotation.Nullable List<ServiceProfileAccessPointType> accessPointTypeConfigs) {
  ...
  public ServiceProfile customFields(@javax.annotation.Nullable List<CustomField> customFields) {
  ...
  public ServiceProfile marketingInfo(@javax.annotation.Nullable MarketingInfo marketingInfo) {
  ...
  public ServiceProfile ports(@javax.annotation.Nullable List<ServiceProfileAccessPointCOLO> ports) {
    this.ports = ports;
    return this;
  }
  ...
  public ServiceProfile virtualDevices(@javax.annotation.Nullable List<ServiceProfileAccessPointVD> virtualDevices) {
  ...
  public ServiceProfile metros(@javax.annotation.Nullable List<ServiceMetro> metros) {
    this.metros = metros;
    return this;
  }
  ...
  public ServiceProfile environments(@javax.annotation.Nullable List<ProviderEnvironment> environments) {
    this.environments = environments;
    return this;
  }

  public ServiceProfile addEnvironmentsItem(ProviderEnvironment environmentsItem) {
  ...
  public ServiceProfile lastMileConfig(@javax.annotation.Nullable ServiceProfileLastMileConfig lastMileConfig) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.state, serviceProfile.state) &&
        ...
        Objects.equals(this.environments, serviceProfile.environments) &&
        Objects.equals(this.selfProfile, serviceProfile.selfProfile) &&
        Objects.equals(this.projectId, serviceProfile.projectId) &&
        Objects.equals(this.lastMileConfig, serviceProfile.lastMileConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(state, account, project, change, changeLog, href, type, name, uuid, description, notifications, tags, visibility, allowedEmails, accessPointTypeConfigs, customFields, marketingInfo, ports, virtualDevices, metros, environments, selfProfile, projectId, lastMileConfig);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ServiceProfile.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in ServiceProfile is not found in the empty JSON string", ServiceProfile.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ServiceProfile.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ServiceProfile` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `state`
      if (jsonObj.get("state") != null && !jsonObj.get("state").isJsonNull()) {
        ServiceProfileStateEnum.validateJsonElement(jsonObj.get("state"));
      }
