...
public class PhysicalPort {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, type, id, state, account, interfaceSpeed, interfaceType, uuid, tether, demarcationPoint, settings, _interface, notifications, additionalInfo, order, operation, loas);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PhysicalPort.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PhysicalPort` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
