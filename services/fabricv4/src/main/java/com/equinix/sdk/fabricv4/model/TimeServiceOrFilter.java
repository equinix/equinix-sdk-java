...
public class TimeServiceOrFilter {
  ...
  public TimeServiceOrFilter or(@javax.annotation.Nullable List<TimeServiceSimpleExpression> or) {
    this.or = or;
    return this;
  }
  ...
  public void setOr(@javax.annotation.Nullable List<TimeServiceSimpleExpression> or) {
    this.or = or;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TimeServiceOrFilter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TimeServiceOrFilter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in TimeServiceOrFilter is not found in the empty JSON string", TimeServiceOrFilter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TimeServiceOrFilter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TimeServiceOrFilter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("or") != null && !jsonObj.get("or").isJsonNull()) {
        ...
        if (jsonArrayor != null) {
          ...
          for (int i = 0; i < jsonArrayor.size(); i++) {
            TimeServiceSimpleExpression.validateJsonElement(jsonArrayor.get(i));
          };
        }
      }
  }
