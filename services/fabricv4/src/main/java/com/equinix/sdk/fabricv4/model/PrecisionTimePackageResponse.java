...
public class PrecisionTimePackageResponse {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(href, type, code, bandwidth, clientsPerSecondMax, redundancySupported, multiSubnetSupported, accuracySlaUnit, accuracySla, accuracySlaMin, accuracySlaMax, changelog);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrecisionTimePackageResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PrecisionTimePackageResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
