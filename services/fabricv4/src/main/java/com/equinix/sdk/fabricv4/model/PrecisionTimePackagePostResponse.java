...
public class PrecisionTimePackagePostResponse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("href", "code"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrecisionTimePackagePostResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PrecisionTimePackagePostResponse is not found in the empty JSON string", PrecisionTimePackagePostResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PrecisionTimePackagePostResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PrecisionTimePackagePostResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
