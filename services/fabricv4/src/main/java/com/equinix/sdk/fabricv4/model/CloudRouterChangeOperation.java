...
public class CloudRouterChangeOperation {
  ...
  public CloudRouterChangeOperation op(@javax.annotation.Nonnull OpEnum op) {
    this.op = op;
    return this;
  }
  ...
  public CloudRouterChangeOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public CloudRouterChangeOperation value(@javax.annotation.Nonnull Object value) {
    this.value = value;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CloudRouterChangeOperation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CloudRouterChangeOperation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in CloudRouterChangeOperation is not found in the empty JSON string", CloudRouterChangeOperation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudRouterChangeOperation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CloudRouterChangeOperation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
