...
public class CloudEvent {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(spec, source, id, type, subject, time, dataschema, datacontenttype, severitynumber, severitytext, equinixalert, equinixorganization, equinixproject, authtype, authid, traceparent, tracestate, data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CloudEvent.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CloudEvent` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
