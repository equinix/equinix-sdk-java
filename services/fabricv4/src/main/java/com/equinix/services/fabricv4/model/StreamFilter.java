...
import com.equinix.services.fabricv4.model.StreamFilterOrFilter;
import com.equinix.services.fabricv4.model.StreamFilterSimpleExpression;
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<StreamFilter>() {
                ...
                public void write(JsonWriter out, StreamFilter value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemae: StreamFilterOrFilter, StreamFilterSimpleExpression");
                }
