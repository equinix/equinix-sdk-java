...
import com.equinix.services.fabricv4.model.ServiceProfileAndFilter;
import com.equinix.services.fabricv4.model.ServiceProfileSimpleExpression;
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<ServiceProfileFilter>() {
                ...
                public void write(JsonWriter out, ServiceProfileFilter value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemae: ServiceProfileAndFilter, ServiceProfileSimpleExpression");
                }
