...
public class StreamGetSubscriptions {
  ...
  * @throws IOException if the JSON Element is invalid with respect to StreamGetSubscriptions
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StreamGetSubscriptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
