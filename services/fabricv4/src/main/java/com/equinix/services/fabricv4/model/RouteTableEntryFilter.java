...
public class RouteTableEntryFilter extends AbstractOpenApiSchema {
            ...
            return (TypeAdapter<T>) new TypeAdapter<RouteTableEntryFilter>() {
                ...
                public void write(JsonWriter out, RouteTableEntryFilter value) throws IOException {
                    ...
                    if (value.getActualInstance() instanceof RouteTableEntrySimpleExpression) {
                      JsonElement element = adapterRouteTableEntrySimpleExpression.toJsonTree((RouteTableEntrySimpleExpression)value.getActualInstance());
                    ...
                    if (value.getActualInstance() instanceof RouteTableEntryOrFilter) {
                      JsonElement element = adapterRouteTableEntryOrFilter.toJsonTree((RouteTableEntryOrFilter)value.getActualInstance());
                      elementAdapter.write(out, element);
                      return;
                    }
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemae: RouteTableEntryOrFilter, RouteTableEntrySimpleExpression");
                }
                ...
                public RouteTableEntryFilter read(JsonReader in) throws IOException {
                    ...
                    try {
                      ...
                      RouteTableEntrySimpleExpression.validateJsonElement(jsonElement);
                      actualAdapter = adapterRouteTableEntrySimpleExpression;
                      RouteTableEntryFilter ret = new RouteTableEntryFilter();
                      ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                      return ret;
                    } catch (Exception e) {
                      // deserialization failed, continue
                      errorMessages.add(String.format("Deserialization for RouteTableEntrySimpleExpression failed with `%s`.", e.getMessage()));
                    ...
                    try {
                      // validate the JSON object to see if any exception is thrown
                      RouteTableEntryOrFilter.validateJsonElement(jsonElement);
                      actualAdapter = adapterRouteTableEntryOrFilter;
                      RouteTableEntryFilter ret = new RouteTableEntryFilter();
                      ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                      return ret;
                    } catch (Exception e) {
                      // deserialization failed, continue
                      errorMessages.add(String.format("Deserialization for RouteTableEntryOrFilter failed with `%s`.", e.getMessage()));
                      log.log(Level.FINER, "Input data does not match schema 'RouteTableEntryOrFilter'", e);
                    }

                    throw new IOException(String.format("Failed deserialization for RouteTableEntryFilter: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    static {
        schemas.put("RouteTableEntrySimpleExpression", RouteTableEntrySimpleExpression.class);
        schemas.put("RouteTableEntryOrFilter", RouteTableEntryOrFilter.class);
    }
  ...
  * @throws IOException if the JSON Element is invalid with respect to RouteTableEntryFilter
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    ...
    throw new IOException(String.format("The JSON string is invalid for RouteTableEntryFilter with anyOf schemas: RouteTableEntryOrFilter, RouteTableEntrySimpleExpression. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
